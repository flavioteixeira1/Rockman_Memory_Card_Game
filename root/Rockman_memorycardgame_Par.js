...
function mudar_numero_card(){
  numero_selecionado++;
  if(numero_selecionado > 9) {
    numero_selecionado = (numero_selecionado % 10)
  }
...
function mostrar_carta_principal(){
  document.getElementById("selecionado").innerHTML   = caminho_numero(numero_selecionado);
  caminho1 = numero_selecionado;
