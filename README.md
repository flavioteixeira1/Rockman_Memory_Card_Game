...
The other game is a memory card game, try Rockman_Memory_Card_Game_Par.html on browser (drag n drop the file)
You can have it here on codepen <a href="https://codepen.io/flavioteixeira1/full/zYWKwWL">Rockman Memory Card Game Par</a>

Ex: git clone https://github.com/flavioteixeira1/Rockman_Memory_Card_Game.git
